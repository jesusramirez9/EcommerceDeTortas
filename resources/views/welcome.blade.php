            ...
            <div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 items-center ">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mb-8 px-6 md:px-0 text-gray-700 font-semibold">Delicioso queque húmedo de chocolate
                            embebido en un almíbar de chocolate, rellena con dos capas de fudge, cubierta con fudge. Super
                            chocolatosa!!!. Pídela desde su versión mini (10 porciones). Previous
                        </p>
                        <a class="cursor-pointer bg-red-400 p-3 rounded-md font-bold hover:bg-yellow-50 hover:text-black">Ver
                            Antojitos</a>
                    </div>
                </div>
            </div>
            <div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 items-center ">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mb-8 px-6 md:px-0 text-gray-700 font-semibold">Un postre tradicional que gusta a todos, la más cremosa versión la tenemos nosotros. Pídela desde 22cms
                        </p>
                        <a class="cursor-pointer bg-red-400 p-3 rounded-md font-bold hover:bg-yellow-50 hover:text-black">Ver
                            Antojitos</a>
                    </div>
           ...
           <div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 items-center ">
                ...
                <div class="text-center">
                    ...
                    <p class="mb-8 px-6 md:px-0 text-gray-700 font-semibold">Un suave bizcochuelo de vainilla o chocolate, embebido en nuestra deliciosa preparación de tres leches, rellena y cubierta de chantilly y envuelta en una deliciosa corona de chocolate bitter. Pídela desde su versión mini (10 porciones)
                    </p>
                    <a class="cursor-pointer bg-red-400 p-3 rounded-md font-bold hover:bg-yellow-50 hover:text-black">Ver
                        Antojitos</a>
                </div>
           ...
           <div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 items-center ">
                ...
                <div class="text-center">
                    ...
                    <p class="mb-8 px-6 md:px-0 text-gray-700 font-semibold">Delicioso y húmedo bizcochuelo de vainilla, relleno con tres capas, mermelada o manjar, chantilly y fruta en trozos, envueltos. Pídelo en su versión de 6 a 8 porciones, con la fruta que desees (chirimoya, fresas, mango, lúcuma, etc.).
                    </p>
                    <a class="cursor-pointer bg-red-400 p-3 rounded-md font-bold hover:bg-yellow-50 hover:text-black">Ver
                        Antojitos</a>
                </div>
            ...
            <div>
                <div class="relative h-contacto bg-center bg-cover w-full object-cover object-center"
                    ...
                    <div
                        ...
                        <p class="m-0 shdot-text">Riquísimos mini postres para hacer de tus celebraciones algo especial.</p>
            ...
            <div>
                <div class="relative h-contacto bg-center bg-cover w-full object-cover object-center"
                    ...
                    <div
                        ...
                        <p class="m-0 shdot-text">Preparados artesanalmente para deleitar al más exigente paladar.</p>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
            <div class="bg_home1 bg_iniwidth w-full h-80"
                ...
                <div class="cursor-pointer text-center text-white">
                    <div class="bg_hovrbgfuc opacity-70 w-full h-80 hover:opacity-0 transition-all ease-out efectoeas">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 md:gap-8">
            ...
            <div class=" col-span-3  bg-center bg-cover w-full object-cover object-center"
                ...
                <div class="py-8 px-8 ">
                    ...
                    <p class="text-justify text-white">En nuestro rubro existen muchas opciones, sin embargo, podemos
            ...
            <div class="col-span-3  bg-center bg-cover w-full object-cover object-center"
                ...
                <div class="py-16 px-8">
                    ...
                    <p class="text-justify text-white">Nuestros productos son elaborados bajo la más estricta
                        supervisión y uso de productos naturales, no usamos preservantes; solo ingredientes frescos de
